...
func (c *startedServiceClient) FetchURLViaOutbound(ctx context.Context, in *OutboundHTTPFetchRequest, opts ...grpc.CallOption) (*OutboundHTTPFetchResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OutboundHTTPFetchResponse)
	err := c.cc.Invoke(ctx, StartedService_FetchURLViaOutbound_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStartedServiceServer) FetchURLViaOutbound(context.Context, *OutboundHTTPFetchRequest) (*OutboundHTTPFetchResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FetchURLViaOutbound not implemented")
}
...
func _StartedService_FetchURLViaOutbound_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OutboundHTTPFetchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StartedServiceServer).FetchURLViaOutbound(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StartedService_FetchURLViaOutbound_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StartedServiceServer).FetchURLViaOutbound(ctx, req.(*OutboundHTTPFetchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StartedService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FetchURLViaOutbound",
			Handler:    _StartedService_FetchURLViaOutbound_Handler,
		},
		{
