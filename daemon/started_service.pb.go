...
const file_daemon_started_service_proto_rawDesc = "" +
	...
	"\x1bUSB_BACKEND_WINDOWS_VBOXUSB\x10\x042\xc4\x1b\n" +
...
var file_daemon_started_service_proto_msgTypes = make([]protoimpl.MessageInfo, 108)
var file_daemon_started_service_proto_goTypes = []any{
	...
	(*OutboundHTTPFetchRequest)(nil),          // 107: daemon.OutboundHTTPFetchRequest
	(*OutboundHTTPFetchResponse)(nil),         // 108: daemon.OutboundHTTPFetchResponse
	(*Log_Message)(nil),                       // 109: daemon.Log.Message
	nil,                                       // 110: daemon.OpenConnectAuthFormResponse.ValuesEntry
	nil,                                       // 111: daemon.OutboundHTTPFetchRequest.HeadersEntry
	nil,                                       // 112: daemon.OutboundHTTPFetchResponse.HeadersEntry
...
var file_daemon_started_service_proto_depIdxs = []int32{
	...
	111, // 64: daemon.OutboundHTTPFetchRequest.headers:type_name -> daemon.OutboundHTTPFetchRequest.HeadersEntry
	112, // 65: daemon.OutboundHTTPFetchResponse.headers:type_name -> daemon.OutboundHTTPFetchResponse.HeadersEntry
	0,   // 66: daemon.Log.Message.level:type_name -> daemon.LogLevel
	113, // 67: daemon.StartedService.GetVersion:input_type -> google.protobuf.Empty
	113, // 68: daemon.StartedService.SubscribeServiceStatus:input_type -> google.protobuf.Empty
	113, // 69: daemon.StartedService.SubscribeLog:input_type -> google.protobuf.Empty
	113, // 70: daemon.StartedService.GetDefaultLogLevel:input_type -> google.protobuf.Empty
	113, // 71: daemon.StartedService.ClearLogs:input_type -> google.protobuf.Empty
	7,   // 72: daemon.StartedService.SubscribeStatus:input_type -> daemon.SubscribeStatusRequest
	113, // 73: daemon.StartedService.SubscribeGroups:input_type -> google.protobuf.Empty
	113, // 74: daemon.StartedService.GetClashModeStatus:input_type -> google.protobuf.Empty
	113, // 75: daemon.StartedService.SubscribeClashMode:input_type -> google.protobuf.Empty
	...
	107, // 79: daemon.StartedService.FetchURLViaOutbound:input_type -> daemon.OutboundHTTPFetchRequest
	...
	113, // 84: daemon.StartedService.CloseAllConnections:input_type -> google.protobuf.Empty
	113, // 85: daemon.StartedService.GetDeprecatedWarnings:input_type -> google.protobuf.Empty
	113, // 86: daemon.StartedService.GetStartedAt:input_type -> google.protobuf.Empty
	113, // 87: daemon.StartedService.SubscribeOutbounds:input_type -> google.protobuf.Empty
	...
	113, // 90: daemon.StartedService.SubscribeTailscaleStatus:input_type -> google.protobuf.Empty
	...
	43,  // 94: daemon.StartedService.StartTailscaleSSHSession:input_type -> daemon.TailscaleSSHClientMessage
	53,  // 95: daemon.StartedService.SubscribeTaildropInbox:input_type -> daemon.SubscribeTaildropInboxRequest
	54,  // 96: daemon.StartedService.MarkTaildropInboxRead:input_type -> daemon.MarkTaildropInboxReadRequest
	58,  // 97: daemon.StartedService.SendTaildropFiles:input_type -> daemon.TaildropSendClientMessage
	65,  // 98: daemon.StartedService.DownloadTaildropFile:input_type -> daemon.DownloadTaildropFileRequest
	67,  // 99: daemon.StartedService.DeleteTaildropFile:input_type -> daemon.DeleteTaildropFileRequest
	68,  // 100: daemon.StartedService.CancelTaildropReceiving:input_type -> daemon.CancelTaildropReceivingRequest
	69,  // 101: daemon.StartedService.ProvideUSBDevices:input_type -> daemon.USBProviderMessage
	113, // 102: daemon.StartedService.SubscribeUSBIPServerStatus:input_type -> google.protobuf.Empty
	113, // 103: daemon.StartedService.SubscribeOpenConnectStatus:input_type -> google.protobuf.Empty
	96,  // 104: daemon.StartedService.SubmitOpenConnectAuthResponse:input_type -> daemon.OpenConnectAuthResponseSubmission
	97,  // 105: daemon.StartedService.CancelOpenConnectAuthChallenge:input_type -> daemon.OpenConnectAuthChallengeCancel
	113, // 106: daemon.StartedService.SubscribeOpenVPNStatus:input_type -> google.protobuf.Empty
	102, // 107: daemon.StartedService.SubmitOpenVPNChallengeResponse:input_type -> daemon.OpenVPNChallengeSubmission
	103, // 108: daemon.StartedService.CancelOpenVPNChallenge:input_type -> daemon.OpenVPNChallengeCancel
	113, // 109: daemon.StartedService.SubscribeNotifications:input_type -> google.protobuf.Empty
	...
	113, // 114: daemon.StartedService.ClearLogs:output_type -> google.protobuf.Empty
	...
	113, // 119: daemon.StartedService.SetClashMode:output_type -> google.protobuf.Empty
	113, // 120: daemon.StartedService.URLTest:output_type -> google.protobuf.Empty
	16,  // 121: daemon.StartedService.LookupOutboundExternalInfo:output_type -> daemon.OutboundExternalInfoResponse
	108, // 122: daemon.StartedService.FetchURLViaOutbound:output_type -> daemon.OutboundHTTPFetchResponse
	113, // 123: daemon.StartedService.SelectOutbound:output_type -> google.protobuf.Empty
	113, // 124: daemon.StartedService.SetGroupExpand:output_type -> google.protobuf.Empty
	23,  // 125: daemon.StartedService.SubscribeConnections:output_type -> daemon.ConnectionEvents
	113, // 126: daemon.StartedService.CloseConnection:output_type -> google.protobuf.Empty
	113, // 127: daemon.StartedService.CloseAllConnections:output_type -> google.protobuf.Empty
	27,  // 128: daemon.StartedService.GetDeprecatedWarnings:output_type -> daemon.DeprecatedWarnings
	29,  // 129: daemon.StartedService.GetStartedAt:output_type -> daemon.StartedAt
	30,  // 130: daemon.StartedService.SubscribeOutbounds:output_type -> daemon.OutboundList
	32,  // 131: daemon.StartedService.StartNetworkQualityTest:output_type -> daemon.NetworkQualityTestProgress
	34,  // 132: daemon.StartedService.StartSTUNTest:output_type -> daemon.STUNTestProgress
	35,  // 133: daemon.StartedService.SubscribeTailscaleStatus:output_type -> daemon.TailscaleStatusUpdate
	40,  // 134: daemon.StartedService.StartTailscalePing:output_type -> daemon.TailscalePingResponse
	113, // 135: daemon.StartedService.SetTailscaleExitNode:output_type -> google.protobuf.Empty
	113, // 136: daemon.StartedService.TailscaleLogout:output_type -> google.protobuf.Empty
	47,  // 137: daemon.StartedService.StartTailscaleSSHSession:output_type -> daemon.TailscaleSSHServerMessage
	55,  // 138: daemon.StartedService.SubscribeTaildropInbox:output_type -> daemon.TaildropInbox
	113, // 139: daemon.StartedService.MarkTaildropInboxRead:output_type -> google.protobuf.Empty
	63,  // 140: daemon.StartedService.SendTaildropFiles:output_type -> daemon.TaildropSendServerMessage
	66,  // 141: daemon.StartedService.DownloadTaildropFile:output_type -> daemon.DownloadTaildropFileChunk
	113, // 142: daemon.StartedService.DeleteTaildropFile:output_type -> google.protobuf.Empty
	113, // 143: daemon.StartedService.CancelTaildropReceiving:output_type -> google.protobuf.Empty
	70,  // 144: daemon.StartedService.ProvideUSBDevices:output_type -> daemon.USBServerMessage
	81,  // 145: daemon.StartedService.SubscribeUSBIPServerStatus:output_type -> daemon.USBIPServerStatusUpdate
	84,  // 146: daemon.StartedService.SubscribeOpenConnectStatus:output_type -> daemon.OpenConnectStatusUpdate
	113, // 147: daemon.StartedService.SubmitOpenConnectAuthResponse:output_type -> google.protobuf.Empty
	113, // 148: daemon.StartedService.CancelOpenConnectAuthChallenge:output_type -> google.protobuf.Empty
	98,  // 149: daemon.StartedService.SubscribeOpenVPNStatus:output_type -> daemon.OpenVPNStatusUpdate
	113, // 150: daemon.StartedService.SubmitOpenVPNChallengeResponse:output_type -> google.protobuf.Empty
	113, // 151: daemon.StartedService.CancelOpenVPNChallenge:output_type -> google.protobuf.Empty
	104, // 152: daemon.StartedService.SubscribeNotifications:output_type -> daemon.NotificationEvent
