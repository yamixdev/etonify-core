...
func TestEtonifyCapabilities(t *testing.T) {
	...
	require.Equal(t, "session_events", capabilities.URLTestCompletionModel)
	require.True(t, capabilities.SupportsURLTestDeltaStream)
	require.True(t, capabilities.SupportsURLTestSessionStatus)
	require.True(t, capabilities.SupportsURLTestResultRevision)
